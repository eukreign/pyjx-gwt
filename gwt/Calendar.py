...
Factory.registerClass('gwt.Calendar', 'Calendar', Calendar)
...
Factory.registerClass('gwt.Calendar', 'DateField', DateField)
...
Factory.registerClass('gwt.Calendar', 'CalendarPopup', CalendarPopup)
