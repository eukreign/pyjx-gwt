...
Factory.registerClass('gwt.DecoratorPanel', 'DecoratorPanel', DecoratorPanel)
...
Factory.registerClass('gwt.DecoratorPanel', 'DecoratedTabBar', DecoratedTabBar)
...
Factory.registerClass('gwt.DecoratorPanel', 'DecoratedTabPanel', DecoratedTabPanel)
...
Factory.registerClass('gwt.DecoratorPanel', 'DecoratorTitledPanel', DecoratorTitledPanel)
