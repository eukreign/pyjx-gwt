...
Factory.registerClass('gwt.DisclosurePanel', 'ClickableHeader', ClickableHeader)
...
#Factory.registerClass('gwt.DisclosurePanel', 'DefaultHeader', DefaultHeader)
...
Factory.registerClass('gwt.DisclosurePanel', 'DisclosurePanel', DisclosurePanel)
