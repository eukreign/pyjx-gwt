...
from gwt.CellPanel import CellPanel
from gwt import HasHorizontalAlignment
from gwt import HasVerticalAlignment
...
Factory.registerClass('gwt.VerticalPanel', 'VerticalPanel', VerticalPanel)
